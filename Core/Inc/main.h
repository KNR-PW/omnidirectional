...
#define AJSFafsdfdsazxc_Pin GPIO_PIN_14
#define AJSFafsdfdsazxc_GPIO_Port GPIOB
...
#define BLACK2_Pin GPIO_PIN_9
#define BLACK2_GPIO_Port GPIOA
#define WHITE2_Pin GPIO_PIN_10
